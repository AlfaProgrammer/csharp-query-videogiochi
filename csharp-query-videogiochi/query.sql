...
-- SELECT count(*) as numero_tornei FROM tournaments WHERE "year" = 2015; 

-- 6- Selezionare tutti i premi che contengono nella descrizione la parola 'facere' (2)
-- SELECT * FROM awards WHERE "description" LIKE '%facere%';

-- 7- Selezionare tutti i videogame che hanno la categoria 2 (FPS) o 6 (RPG), mostrandoli una sola volta (del videogioco vogliamo solo l'ID) (287)
--SELECT categories."name" as categoria, count(videogames.id) as n_giochi from videogames
...
-- SELECT count(DISTINCT videogame_id) as numero_giochi_con_5_stelle FROM reviews WHERE rating = 5; 
